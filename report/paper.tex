...
\textbf{Note}. The code extensively uses \texttt{Julia}'s functionality by allowing for a wide range of \textsc{unicode} characters, such as Greek letters.
My GitHub page provides further instructions on how to install the special font which allows for using those. 
