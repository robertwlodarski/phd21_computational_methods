function [w, T] = fnSolvePricesBisection(pTau,pEta,pChi,pBeta,pSigmaz,pAlpha,pA,pa,pr,pb,pMaxIter,pStepSize,pMaxWage)
    % Initialise (wage found via bisection)
    iT              = 1.0;
    iIteration      = 0;
    iConvergence    = false;
    ...
    while iIteration < pMaxIter
        % Households supply
        iWage                       = fnWageBisection(iT,pTau,pEta,pChi,pBeta,pSigmaz,pa,pr,pb,pMaxIter,pStepSize,pA,pAlpha,pMaxWage);
